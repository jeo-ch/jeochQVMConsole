...
export const fieldDescriptions: Record<string, string> = {
  ...
  api_key_id: 'API 凭证标识；与 API Key 一起用于 API Key 认证。',
  ...
  id: '资源 ID。',
  iface: '网卡名称。',
  idle_expires_at: '公网登录会话在连续无操作后的失效时间。',
  idle_timeout_seconds: '公网登录会话连续无操作失效时长，单位秒。',
  image_url: '展示图片地址。',
  ...
  public_access_enabled: '是否允许非局域网来源访问面板。',
  public_usable: '当前 API 凭证是否满足公网使用条件。',
  publish: '是否发布模板。',
  published: '是否已发布。',
  ...
  timezone: '时区。',
  token: '流程令牌或下载令牌。',
  trusted_ip: '管理员 API Key 允许访问的单个固定 IPv4 或 IPv6 地址。',
