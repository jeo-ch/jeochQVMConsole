  ...
  const loadDetail = useCallback(async (silent = false, forceHTTP = false) => {
    ...
    try {
      ...
      const detailConfig = {
        ...
        memory_virtio_mem_current: detail.memory_virtio_mem_current,
        ...
        memory_balloon_status: detail.memory_balloon_status,
        memory_observation_until: detail.memory_observation_until,
        memory_manual_pause_until: detail.memory_manual_pause_until,
      }
